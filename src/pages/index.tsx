...
import { Icon, type IconName } from "@site/src/components/ui/Icon";
import { CTAButtons } from "@site/src/components/marketing/CTAButtons";
import { CTASection } from "@site/src/components/marketing/CTASection";
import { BlockscoutBanner } from "@site/src/components/marketing/BlockscoutBanner";
import { Section } from "@site/src/components/marketing/Section";
import { ReportPreview } from "@site/src/components/marketing/ReportPreview";
import { StatBand } from "@site/src/components/marketing/StatBand";
import { LogoStrip } from "@site/src/components/marketing/LogoStrip";
import AnalysisDemo from "@site/src/components/AnalysisDemo/AnalysisDemo";

const PAGE_TITLE = "AI Smart Contract Auditing | Find Vulnerabilities Before Attackers Do";
const PAGE_DESC =
    ...
    <Layout title={PAGE_TITLE} description={PAGE_DESC}>
      ...
      >
        ...
        <div className="mt-12 grid items-center gap-8 lg:grid-cols-2">
          <Card variant="elevated" padding={16}>
            {/* The chart SVG has dark text/axes — keep it on a light panel in both themes. */}
      ...
      >
        <div className="mx-auto max-w-4xl overflow-hidden rounded-2xl bg-ink-900 shadow-lg">
          <video controls preload="metadata" className="h-auto w-full" poster="/img/video-poster.svg">
