...
const pillars = [
  ...
  },
  {
    ...
    body:
      'A manual DeFi audit runs $40K–$100K and 3–38 days. Savant Chat audits a typical codebase in 10–30 minutes, pay-as-you-go from $0.07/line — on every commit via GitHub and GitLab CI.',
  },
  {
    index: '03',
