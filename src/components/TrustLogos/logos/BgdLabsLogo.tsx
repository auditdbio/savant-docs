...
export default function BgdLabsLogo(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 248 84" fill="currentColor" aria-hidden="true" focusable="false" {...props} style={{color: 'var(--logo-ink, currentColor)', ...props.style}}>
      ...
      />
      <text x="102" y="32" fill="currentColor" fontFamily="Geist, ui-sans-serif, system-ui, sans-serif" fontSize="26" fontWeight="700">
        BGD
      </text>
      <text x="102" y="64" fill="currentColor" fontFamily="Geist, ui-sans-serif, system-ui, sans-serif" fontSize="26" fontWeight="700">
        LABS
      </text>
    </svg>
  );
