...
echo "Done! The $TARGET_DIR directory has been created and archived as $ARCHIVE"
```
...
You'll get a `your-project-name-savant.zip` archive (or `.tar.gz` if `zip` isn't installed) in your project folder with all dependencies included. Upload it to [Savant Chat](https://savant.chat) and run the audit.
