...
Some repositories need more: non-standard dependency managers, outdated compiler versions, closed-source libraries — or git submodules, which GitHub's ZIP export leaves empty and which Foundry needs to build.
