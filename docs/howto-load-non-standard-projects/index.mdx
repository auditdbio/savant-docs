...
title: HOWTO Load Non-Standard Projects
sidebar_label: Loading Non-Standard Projects
sidebar_position: 3
description: >-
  How to upload Foundry projects with git submodules, non-standard dependency
  managers, or closed-source libraries to Savant Chat for an AI smart contract
  audit — with a ready-to-use packaging script.
keywords:
