...
/**
 * Savant Chat design-system theme.
 * Brand DNA: flame orange (primary action) + plum purple (headings/brand),
 * a cool neutral ramp, plum-tinted "ink" dark surfaces, and a first-class
 * severity scale (audit findings are the product).
 * Per project decision: fonts use the system stack (Geist is NOT loaded).
 */
const config: Config = {
  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        ink: {
          950: "#150A1C", 900: "#1C1126", 800: "#271832", 700: "#352343",
        },
        neutral: {
        ...
        // Semantic aliases bound to CSS custom properties (theme-aware).
        surface: {
