      ...
      <div className="container-max grid grid-cols-1 gap-8 py-13 pb-7 md:grid-cols-[1.4fr_1fr_1fr_1fr] md:py-12">
        <div>
          <div className="mb-3 flex items-center gap-[10px]">
            ...
            <span className="text-[17px] font-extrabold text-plum-700">Savant</span>
          </div>
              ...
              {col.links.map((link) => (
                <li key={link.label}>
                  <a
                    ...
                    className="text-[14px] text-text-body transition-colors hover:text-text-strong"
                  >
                    {link.label}
                  </a>
                </li>
      ...
      <div className="container-max pb-8">
        <div className="border-t border-[var(--border-subtle)] pt-5 text-center">
          <p className="text-[13px] text-text-subtle">
            © {year} Novel Codes DMCC. All rights reserved.
          </p>
          <div className="mt-4 flex items-center justify-center gap-2">
            <img
              src="/img/visa_mastercard_unionpay.jpg"
              alt="Visa, Mastercard, UnionPay"
              className="h-4"
            />
          </div>
        </div>
